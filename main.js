...
//   const highlight_code = document.querySelectorAll("deckgo-highlight-code")//.classList.remove("loading-code");
//   const btn_copy = document.querySelector(".btn-copy");
//   console.log(document.querySelector(".btn-copy"));
//   for(let i = 0; i < highlight_code.length; i++){
//     highlight_code[i].classList.toggle("loading-code");
//     console.log(highlight_code[i].value);
//   }
